...
const DefaultsChart = ({ data, ...rest }: ClientChartProps) => {
        ...
        formatter: (params: Array<{ data: number }>) => {
          if (Array.isArray(params)) {
            ...
            return `<div style="position:relative; border-radius:10px;">
              <p style="font-size:${theme.typography.caption.fontSize}; font-weight:400; text-align:center;">Default(s)</p>
